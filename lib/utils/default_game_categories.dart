...
import "../classes/solvables/equations/addition.dart";
import "../classes/solvables/equations/equation.dart";
import "../classes/solvables/equations/multiplication.dart";
import "../classes/solvables/fractions/addition.dart";
import "../classes/solvables/fractions/equation.dart";
import "../classes/solvables/fractions/multiplication.dart";
import "../classes/solvables/percentages/percentage.dart";
import "../classes/solvables/percentages/sale.dart";

/// A list of default game categories
class DefaultGameCategories {
  /// FRACTIONS
  static GameCategory get fraction => GameCategory(
        name: "fraction",
        rawTranslations: {
          "en": {
            "title": "Fractions",
  ...
  /// EQUATIONS
  static GameCategory get equation => GameCategory(
        name: "equation",
        rawTranslations: {
          "en": {
            "title": "Equations",
  ...
  /// PERCENTAGE
  static GameCategory get percentage => GameCategory(
        name: "percentage",
        rawTranslations: {
          "en": {
            "title": "Percentage",
