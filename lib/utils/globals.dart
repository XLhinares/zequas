...
const String versionNumber = "v3.4.2";
...
/// The default duration for short animations within the app.
const Duration animDurationShort = Duration(milliseconds: 200);

/// The default duration for long animations within the app.
const Duration animDurationLong = Duration(milliseconds: 400);
...
ThemeData themePastel = xTheme.getTheme(
  ...
  cardColor: Colors.white.withAlpha(180),
);
