...
/// which we cycle
class GamePlugin extends AppManagerPlugin {
  // CONSTRUCTOR ===============================================================
  ...
  double get progress => _turns.isEmpty ? 1 : _index / _turns.length;
  ...
  UnmodifiableListView<ArchivedTurn> get history =>
  ...
  void _prepareNewGame() {
    if (mode == null) {
      throw AssertionError("Mode cannot be null when preparing a game");
    }
    ...
    for (int i = 0; i < app.cookies.gameLength.value; i++) {
